...
function incluirAnexo() {
    ...
    if (file) {
        ...
        alert('Selecione um documento antes de anexar.');
        return;
    }
    ...
    $("#incAnexo").fadeOut('fast');
    $("#documentoInput").fadeOut('fast');
}
...
function excluirAnexo(button) {
    ...
    var tr = button.closest('tr');
    tr.remove();
    $("#incAnexo").fadeIn('fast');
    $("#documentoInput").fadeIn('fast');
    $("#documentoInput").val('');
}
...
function visualizarDocumento() {
    ...
    if (blobURL) {
        ...
        alert('Anexe um documento antes de fazer o download.');
    }
}
...
function salvarFornecedor() {
    ...
    if (!camposObrigatoriosPreenchidos) {
        alert("Preencha os campos obrigaórios!");
        return;
    }
